...
fn s3error_to_error(error: &S3Error) -> Error {
    match error {
        ...
        S3Error::EntityTooLarge => Error {
            status: http::StatusCode::BAD_REQUEST.into(),
            code: "EntityTooLarge".to_string(),
            message: "Your proposed upload exceeds the maximum allowed object size.".to_string(),
            resource: "".to_string(),
            request_id: "".to_string(),
        },
        S3Error::MissingContentLength => Error {
            status: http::StatusCode::LENGTH_REQUIRED.into(),
            code: "MissingContentLength".to_string(),
            message: "You must provide the Content-Length HTTP header.".to_string(),
            resource: "".to_string(),
            request_id: "".to_string(),
        },
        ...
        S3Error::MaxMessageLengthExceeded => Error {
            status: http::StatusCode::BAD_REQUEST.into(),
            code: "MaxMessageLengthExceeded".to_string(),
            message: "Your request was too big.".to_string(),
            resource: "".to_string(),
            request_id: "".to_string(),
        },
